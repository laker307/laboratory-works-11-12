...
class DoSoChKa:
    ...
    def queen(self):  # Угрожает ли ферзь
        ...
        if (self.k == self.m) or (self.l == self.n) or (abs(self.k - self.m) == abs(self.l - self.n)):
            print('\nб) Ферзь (красное поле) угражает выбранному полю (синее поле)')
        else:
            print('\nб) Ферзь (красное поле) не угражает выбранному полю (синее поле)')
            self.q = 'n'
    ...
    def mustang(self):  # Угрожает ли конь
        if ((abs(self.k - self.m) == 2) and (abs(self.l - self.n) == 1)) or ((abs(self.k - self.m) == 1) and (abs(self.l - self.n) == 2)):
            print('\nв) Конь (красное поле) угражает выбранному полю (синее поле)')
        else:
            print('\nв) Конь (красное поле) не угражает выбранному полю (синее поле)')
